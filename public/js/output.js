    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.post('http://127.0.0.1:3000/api/auth/login', {
            username: email,
            password: password
          });
        case 3:
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _axios.default.get('http://127.0.0.1:3000/api/auth/logout');
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
...
exports.removeFilters = exports.loadFilters = exports.formates = exports.catagories = void 0;
var formates = ['Paperback', 'Hardback', 'Mixed media product', 'Spiral bound', 'Cards', 'Fold-out book or chart', 'CD-Audio', 'Book', 'Game', 'Board book', 'Bath book', 'Notebook / blank book', 'Sheet music', 'Postcard book or pack', 'Calendar', 'Leather / fine binding', 'Diary', 'Novelty book', 'Loose-leaf', 'DVD video', 'Boxed Set', 'Sheet map', 'Toy', 'General merchandise', 'Other merchandise', 'Multiple copy pack'];
exports.formates = formates;
var catagories = ['Medical', 'Science-Geography', 'Art-Photography', 'Biography', 'Business-Finance-Law', 'Childrens-Books', 'Computing', 'Crafts-Hobbies', 'Crime-Thriller', 'Dictionaries-Languages', 'Entertainment', 'Food-Drink', 'Graphic-Novels-Anime-Manga', 'Health', 'History-Archaeology', 'Home-Garden', 'Humour', 'Mind-Body-Spirit', 'Natural-History', 'Personal-Development', 'Poetry-Drama', 'Reference', 'Religion', 'Romance', 'Science-Fiction-Fantasy-Horror', 'Society-Social-Sciences', 'Sport', 'Stationery', 'Teaching-Resources-Education', 'Technology-Engineering', 'Teen-Young-Adult', 'Transport', 'Travel-Holiday-Guides'];
exports.catagories = catagories;
var getFilter = function getFilter(item, index) {
  var div = document.createElement('div');
  div.className = "filter ".concat(item, " filter-item");
  var input = document.createElement('input');
  input.type = 'checkbox';
  input.id = "filter-".concat(index);
  input.name = 'filter';
  input.value = item;
  var label = document.createElement('label');
  label.htmlFor = "filter-".concat(index);
  label.innerText = item;
  div.appendChild(input);
  div.appendChild(label);
  return div;
};
var loadFilters = function loadFilters(node, data) {
  console.log(data);
...
var removeFilters = function removeFilters(node) {
...
var login_btn = document.querySelector('.login-btn-action');
var signup_btn = document.querySelector('.signup-btn-action');
var logout_btn = document.querySelector('.logout-btn');
if (login_btn) login_btn.addEventListener('click', function (e) {
...
if (logout_btn) logout_btn.addEventListener('click', function (e) {
  e.preventDefault();
  (0, _auth.logout)();
  // alert(`Email: ${email} Password: ${password}`);
});

if (signup_btn) signup_btn.addEventListener('click', function (e) {
  var email = document.getElementById('email').value;
  var password = document.getElementById('password').value;
  console.log(email, password);
  e.preventDefault();
...
function addclicklisterner(node, listnode, data) {
  node.addEventListener('click', function () {
    ...
    if (listnode.childElementCount == 5) {
      (0, _script.loadFilters)(listnode, data.slice(5, data.length));
      node.innerHTML = '<u>See less</u>';
      // more_less.
    } else {
      (0, _script.removeFilters)(listnode);
...
//formate filter list
var formate_list = document.getElementById('formates-list');
if (formate_list) (0, _script.loadFilters)(formate_list, _script.formates.slice(0, 5));
var more_less_formates = document.getElementById('more-less-formates');
if (more_less_formates) addclicklisterner(more_less_formates, formate_list, _script.formates);

//catagory filter list
var catagory_list = document.getElementById('catagories-list');
if (catagory_list) (0, _script.loadFilters)(catagory_list, _script.catagories.slice(0, 5));
var more_less_catagories = document.getElementById('more-less-catagories');
if (more_less_catagories) addclicklisterner(more_less_catagories, catagory_list, _script.catagories);
},{"./auth":"auth.js","./script":"script.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
